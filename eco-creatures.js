...
const SPECIES_DEFS = {
    ...
    leviathan:  { diet:'apex', baseColor:'#ff6b35', size:[40,80],  speed:[0.7,1.0], sense:160, reproduce:0.0008, hunger:100, seekMate:170, mateMin: 100, mateR: 3.5*200,  activeAtNight:true,  minBreedAge:1000, breedCooldown:1200, litterSize:[1,1], maxAge:[7000,9000], spawnEnergy:150, maxEnergy:250},  // 200→500
};
