...
const SPECIES_DEFS = {
    ...
    manta:      { diet:'herb', baseColor:'#00fff5', size:[14,24],  speed:[0.3,0.8],  sense:90,  reproduce:0.0015, hunger:90, seekMate:120, mateMin: 80, mateR: 2.5*90, activeAtNight:true, minBreedAge:350,  breedCooldown:450,  litterSize:[2,2], maxAge:[3000,6000], spawnEnergy:80, maxEnergy:200},
