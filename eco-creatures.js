...
const SPECIES_DEFS = {
    ...
    anglerfish: { diet:'carn', baseColor:'#ff2d78', size:[14,26],  speed:[0.5,1.0],  sense:130, reproduce:0.0008, hunger:80, seekMate:120, mateMin: 80, mateR: 3.5*120,  activeAtNight:true,  minBreedAge:600,  breedCooldown:850,  litterSize:[1,3], maxAge:[4000,7000], spawnEnergy:90, maxEnergy:200},  // 200→300
