...
const SPECIES_DEFS = {
    ...
    shark:      { diet:'carn', baseColor:'#cc00ff', size:[18,32],  speed:[0.8,1.4],  sense:120, reproduce:0.0008, hunger:80, seekMate:120, mateMin: 80, mateR: 3.5*120,  activeAtNight:true,  minBreedAge:700,  breedCooldown:900,  litterSize:[1,3], maxAge:[4000,7000], spawnEnergy:90, maxEnergy:200},  // 200→300
    anglerfish: { diet:'carn', baseColor:'#ff2d78', size:[14,26],  speed:[0.3,0.9],  sense:130, reproduce:0.0008, hunger:80, seekMate:120, mateMin: 80, mateR: 3.5*150,  activeAtNight:true,  minBreedAge:600,  breedCooldown:850,  litterSize:[1,3], maxAge:[4000,7000], spawnEnergy:80, maxEnergy:200},  // 200→300
