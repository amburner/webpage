...
const SPECIES_DEFS = {
    ...
    leviathan:  { diet:'apex', baseColor:'#ff6b35', size:[40,120],  speed:[0.7,1.2], sense:200, reproduce:0.0008, hunger:150, seekMate:200, mateMin: 100, mateR: 3.5*200,  activeAtNight:true,  minBreedAge:2500, breedCooldown:1800, litterSize:[1,1], maxAge:[7000,15000], spawnEnergy:150, maxEnergy:300},  // 200→500
};
